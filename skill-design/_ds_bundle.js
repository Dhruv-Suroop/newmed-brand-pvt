...
/** The NewMed Skills orange symbol (chevron shards). Real brand mark, inline. */
function Symbol({
  size = 40,
  style = {}
}) {
...
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/** Checkbox with orange fill when checked. Controlled or uncontrolled. */
function Checkbox({
  label,
  checked,
  defaultChecked,
...
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/** Text input with label, optional hint/error, calm orange focus ring. */
function Input({
  label,
  hint,
  error,
...
try { (() => {
/** Radio group — one choice per row, orange dot when selected. */
function Radio({
  name,
  options = [],
  value,
...
try { (() => {
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
/** Native select styled to match Input — labelled, orange focus. */
function Select({
  label,
  hint,
  id,
...
const stageTone = ["neutral", "yellow", "yellow", "teal", "orange", "success"];
function Sidebar({
  view,
  setView
}) {
...
function Drawer({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    tone: v === "Verified" || v === "Issued" ? "success" : "yellow",
    dot: true
