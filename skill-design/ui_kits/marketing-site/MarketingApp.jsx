...
function Hero({ audience, onBook }) {
  ...
  return (
    <section style={{ position: "relative", overflow: "hidden" }}>
      <Orb tone="orange" size={720} style={{ position: "absolute", right: -240, top: -260 }} />
      <Orb tone="yellow" size={420} style={{ position: "absolute", left: -180, bottom: -240, opacity: 0.7 }} />
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 24 }}>
          {items.map(([h, p]) => (
            <Card key={h} padding={28} interactive>
              <Badge tone="orange" style={{ marginBottom: 16 }}>Ready</Badge>
...
function CTABand({ onBook }) {
  return (
    <section style={{ position: "relative", overflow: "hidden", background: "var(--nm-ink)" }}>
      <Orb tone="orange" size={560} style={{ position: "absolute", right: -160, bottom: -300, opacity: 0.5 }} />
