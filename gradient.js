...
(function () {
  ...
  var RECIPES = {
    sunrise:  { ground: 'cream', blobs: ['orange', 'orange', 'amber', 'linen'] },
    amberrise:{ ground: 'cream', blobs: ['amber', 'amber', 'orange', 'linen'] },
    organic:  { ground: 'cream', blobs: ['amber', 'orange', 'linen', 'amber', 'orange'] },
    deep:     { ground: 'linen', blobs: ['clay', 'orange', 'amber', 'clay'] },
    cool:     { ground: 'cream', blobs: ['teal', 'amber', 'linen', 'teal'] }
  };
