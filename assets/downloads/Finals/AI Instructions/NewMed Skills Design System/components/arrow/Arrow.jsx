...
export function Arrow({
  children, fill = "coral", outline = false, stroke = "var(--brand-primary)",
 ...
 */
export function ArrowPortrait({ src, width = 520, height = 400, jut = 0.32, fill = "coral", imgScale = 1.15, imgShift = 0, alt = "", style = {} }) {
  const idRef = React.useRef(null);
...
export function ArrowIcon({ children, size = 44, fill = "coral", outline = false, stroke = "var(--brand-primary)", strokeWidth = 2, style = {}, contentStyle = {} }) {
